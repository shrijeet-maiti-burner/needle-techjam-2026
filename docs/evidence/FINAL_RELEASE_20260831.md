...
Everything below is the record of the run made at `1c5b005`, left exactly as
measured. Four things in it no longer describe the release:
...
- the index is schema **9**, not 8. Schema 8 assets are refused, because they
  ...
  parser produced it;
- the archive carries more tracked files. `scripts/demo_session.py`,
