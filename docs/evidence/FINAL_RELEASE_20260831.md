...
- `python -m unittest discover -s tests -v`: 407 passed, three skipped because
...
The verified final archive is
`.artifacts/releases/needle-human-loop-final.zip`: 24,879,771 bytes, 22 tracked
source files plus the generated manifest and schema-8 asset, SHA-256
`1d3bc06968a0b5d288367dc4d1e108a41536a1095f53ad10a55313967c3c93d8`.
...
Report: `.artifacts/qa/robustness-final/20260831T032140Z-4e36df64/report.json`
