...
- [EXP-006/008/018 state, lexical, and robustness evidence, 29 August](evidence/EXP_006_008_018.md): subject-preserving override passed, lexical rewrites failed, invalid surface runs were excluded, and the current primary plus rollback were selected without freezing.
